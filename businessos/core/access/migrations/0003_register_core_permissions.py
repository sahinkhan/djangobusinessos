...
# Historical migration input is intentionally frozen here. Runtime declarations live in
# businessos.core.access.permissions and may evolve without changing zero-state replay.
